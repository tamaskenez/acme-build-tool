...
macro(acme_add_library _aal_name)
	...
	endforeach()
	add_library("${_aal_name}" ${_aal_v} ${_AAL_FILES})
...
function(acme_add_public_headers target_name)
	...
	if(${mode} STREQUAL FILES)
		...
		foreach(i ${APH_FILES})
			...
			acme_dictionary_set(header_map ${i} ${dest_dir})
			list(APPEND ACME_PUBLIC_HEADER_FILES ${i})
		endforeach()
		set_target_property(${target_name} PROPERTIES ACME_PUBLIC_HEADER_TO_DESTINATION_MAP_KEYS "${header_map_KEYS}")
		set_target_property(${target_name} PROPERTIES ACME_PUBLIC_HEADER_TO_DESTINATION_MAP_VALUES "${header_map_VALUES}")
