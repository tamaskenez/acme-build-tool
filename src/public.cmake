...
macro(acme_add_executable _aae_name)
	...
	set(_aae_status regular_args)
	foreach(_aae_i ${ARGN})
		if(_aae_status STREQUAL regular_args)
			if()
	endmacro()
endmacro()

macro(acme_add_executable _aae_target_name)
	set(ACME_TARGET_TYPE EXECUTABLE)
	set(ACME_IS_EXECUTABLE 1)
	set(ACME_IS_LIBRARY 0)
	set(ACME_IS_STATIC 0)
	acme_add_target_and_install_all()
endmacro()

# acme_add_library([SHARED|STATIC|MODULE])
# Call without parameters to add a library
# whose type will be determined by the BUILD_SHARED_LIBS cmake
# variable
macro(acme_add_library)
	...
	if("${ARGV0}" STREQUAL "")
		if(BUILD_SHARED_LIBS)
			set(ACME_TARGET_TYPE SHARED)
		else()
			set(ACME_TARGET_TYPE STATIC)
		endif()
	else()
