...
function(acme_generate_and_install_config_module target_name)
	...
	get_target_property(_ACME_TARGET_TYPE ${target_name} TYPE)
	if(_ACME_TARGET_TYPE MATCHES "^(SHARED_LIBRARY|MODULE_LIBRARY)$")
		set(_shared 1)
	else()
		set(_shared 0)
	endif()
	unset(_runtime_library_r)
	unset(_runtime_library_d)
	if(_shared)
		get_target_property(vr ${target_name} LOCATION_Release)
		get_target_property(vd ${target_name} LOCATION_Debug)
		if(vr)
			get_filename_component(j ${vr} NAME)
			set(_runtime_library_r ${j})
		endif()
		if(vd)
			get_filename_component(j ${vd} NAME)
			set(_runtime_library_d ${j})
		endif()
	endif()
	...
	file(RELATIVE_PATH ACME_INSTALL_PREFIX_FROM_CONFIG_MODULE /dummy/${ACME_CONFIG_MODULE_DESTINATION} /dummy)
